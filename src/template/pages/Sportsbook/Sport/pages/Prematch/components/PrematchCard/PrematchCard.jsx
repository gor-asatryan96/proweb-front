...
import { selectPrematchActiveLeague } from '../../../../../../../../redux/reducers/sport/sport.slice';
...
const PrematchCard = ({
  ...
  const onItemClick = () => {
    navigate(`/Sport/${PRE_MATCH}/${sportName}/${country}/${league}/${replaceSpaces(event.eventName)}-${event.eventId}`);
  };
